      ...
      <div className="relative z-10 w-full max-w-md rounded-lg bg-gray-900 bg-opacity-80 p-8 text-white">
        ...
        <form className="space-y-4">
          ...
          <div className="flex items-center">
            <input
              type="checkbox"
              className="h-4 w-4 rounded border-gray-700 bg-gray-800 focus:ring-white"
            />
            <label className="ml-2 text-sm">Remember Me</label>
          </div>
          <button className="w-full rounded-lg bg-gray-700 p-2.5 text-white hover:bg-gray-600">
            Log In
          </button>
          <div className="flex items-center justify-center">
            <p className="ml-2 text-sm">
              Don't have an account ?{" "}
              <Link href="/user/register" className="text-blue-600">
                Register Now
              </Link>
            </p>
          </div>
